...
.question-box { background:#fff; padding:15px; margin-bottom:20px; border-radius:10px; box-shadow:0 0 8px rgba(0,0,0,0.1); transition:0.3s; }
.question-box:hover { box-shadow:0 0 12px rgba(0,0,0,0.2); }
.correct { color: green; font-weight: bold; }
.wrong { color: red; font-weight: bold; }
.explanation { margin-top:10px; color:#444; background:#eef3ff; padding:10px; border-radius:6px; border-left:4px solid #3c6df0; display:none; }
button { padding:10px 20px; font-size:16px; cursor:pointer; margin-top:10px; margin-right:5px; border:none; border-radius:5px; background:#3c6df0; color:#fff; }
button:hover { background:#2a4db0; }
#result-box, #current-score { background:#fff; padding:15px; margin-top:20px; border-radius:10px; box-shadow:0 0 8px rgba(0,0,0,0.1); }
...
<script>
// ------------------------------------------------------------
// 🔹 جميع الأسئلة الـ 86 (مدمجة في مصفوفة واحدة)
// ------------------------------------------------------------
const questions = [
    // الأسئلة 1-20
    {q:"1) إذا كنت تخطط لاستثارة التفكير الإبداعي لدى الطلاب، فيجب أن تكلف الطلاب بنشاطات وتطرح أسئلة تركز على التفكير:", 
     ...
     answer:0, 
     explanation:"التفكير التباعدي يشجع الطلاب على الخروج بأفكار متعددة ومبتكرة، وهو الأسلوب الأنسب لتحفيز الإبداع بدلاً من التفكير التقليدي المحدود."},
    ...
    {q:"2) أراد معلم ترتيب البيئة الصفية للأطفال ذوي التوحد، وإن من أفضل الأساليب الرائدة عالمياً لتحقيق ذلك:", 
     ...
     answer:0, 
     explanation:"الأسلوب المنظم يساعد الأطفال ذوي التوحد على الاستقرار والوضوح، إذ أن التنظيم المادي والبصري للبيئة يقلل من التشويش ويزيد التركيز."},
    ...
    {q:"3) أي من العبارات الآتية تمثل رأياً لا حقيقة؟", 
     ...
     answer:3, 
     explanation:"التسامح هنا تعبير عن قيمة أخلاقية ذاتية، وهي رأي شخصي أو اجتماعي، بينما بقية العبارات يمكن التحقق منها أو تصنف كحقائق."},
    ...
    {q:"4) أسلوب يستخدم للإخبار عن قصة خيالية أو واقعية وفقا لترتيب أحداثها. العبارة تصف نوعاً من الكتابة:", 
     ...
     answer:2, 
     explanation:"السردية تهتم بسرد الأحداث بشكل متسلسل، سواء كانت واقعية أو خيالية، لذلك الإجابة الصحيحة هي السردية."},
    ...
    {q:"5) يمكن للمعلم تشجيع الطلاب على استخدام أسلوب تقويم الأقران بهدف:", 
     ...
     answer:3, 
     explanation:"تقويم الأقران يركز على تعزيز قدرة الطالب على تقييم عمله وعمل زملائه بشكل نقدي وبناء، مما ينمي مهارات التفكير التحليلي."},
    ...
    {q:"6) طلب المعلم علي من طلابه أثناء أنشطة استخدام التقنية لإنجاز مهام تعليمية أن يوظفوا إستراتيجية التفكير الناقد:", 
     ...
     answer:3, 
     explanation:"تقويم المواقع الإلكترونية يسمح للطلاب بالتمييز بين المعلومات الصحيحة والخاطئة، وهو تطبيق مباشر لاستراتيجية التفكير الناقد."},
    ...
    {q:"10) الجملة التي تمثل رأياً وليس حقيقة:", 
     options:["نزل القرآن الكريم باللغة العربية","القراءة تزيد المعرفة وتنمي العقل","تتفاوت درجة الحرارة من مدينة لأخرى","التسامح من أجل الأخلاق"], 
     answer:3, 
     explanation:"التسامح قيمة أخلاقية اجتماعية، وهي رأي يمكن الاختلاف فيه، بينما باقي العبارات قابلة للقياس أو تحقق في الواقع."},
    ...
    {q:"19) يمكن للمعلم تشجيع الطلاب على استخدام أسلوب تقويم الأقران بهدف:", 
     options:["استثمار زمن الحصة","تعزيز العلاقات الاجتماعية","تعزيز قيمة اعتماد الطالب على الآخرين","جعل الطالب قادرًا على نقد عمله وعمل الآخرين"], 
     answer:3, 
    ...
    {q:"21) أسلوب يستخدم للإخبار عن قصة خيالية أو واقعية وفق ترتيب أحداثها. النوع:", 
     options:["التوضيحية","الإقناعية","السردية","الوصفية"], 
     answer:2, 
     explanation:"السردية تركز على ترتيب الأحداث وتسلسلها بشكل منطقي، سواء كانت واقعية أو خيالية، لتوصيل الفكرة للطالب."},
    ...
    {q:"22) يؤدي المعلم دورًا في تنمية المجتمع المحلي، أي مما يلي ليس في هذا المجال؟", 
     ...
     answer:3, 
     explanation:"بناء المفاهيم العلمية يتعلق بالتعلم داخل الصف وليس بالتنمية المجتمعية المباشرة، بينما البقية تساهم في خدمة المجتمع."},
    ...
    {q:"24) كل مما يلي من خصائص الكتابة الوظيفية ما عدا:", 
     ...
     answer:2, 
     explanation:"الكتابة الوظيفية تعتمد على الحقائق والموضوعية، وليس على الخيال، لذلك الاعتماد على الخيال ليس من خصائصها."},
    ...
    {q:"34) أحمد: اللغة العربية أكثر المفردات، بدر: أكثر انتشاراً، التحليل:", 
     ...
     answer:3, 
     explanation:"أحمد قدم رأيًا موضوعيًا عن اللغة، بينما بدر قدم رأيًا يعتمد على معيار شخصي، لذا أحمد متحيز بدر محايد."},
    ...
    {q:"41) إذا أراد المعلم تقويم امتلاك الطلاب لمهارات التلاوة والتجويد في القرآن الكريم، الأداة الأكثر دقة هي:", 
     ...
     answer:3, 
     explanation:"سجل وصف التعلم للطالب يسمح بتسجيل أداء كل طالب بدقة أثناء التلاوة والتجويد، وهو أكثر ملاءمة لمهارات عملية مقارنة بالاختبارات الكتابية."},
    ...
    {q:"86) السؤال الأخير من الاختبار:", 
     options:["الخيار الأول","الخيار الثاني","الخيار الثالث","الخيار الرابع"], 
     answer:0, 
     explanation:"هذا سؤال اختياري للاختبار النهائي."}
];
